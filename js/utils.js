...
siparsFrameworkClass = function () {
},
        siparsFrameworkClass.prototype =
        {
            /*
                ...
                $.ajax({
                    ...
                    success: function (response) {
                        ...
                        if (risposta === 1) {
                            ...
                            siparsFramework.MessageError(descrizione_errore, 'Attenzione');
                            return;
                        }
                    },
                    ...
                    if (result.value) {
                        $.ajax({
                            ...
                            success: function () {
                                ...
                                siparsFrameworkClass.prototype.MessageSuccess("Il record e' stato cancellato con succcesso", "Cancellazione effettuata", '', NoReolad);
                            },
                            error: function (xhr, ajaxOptions, thrownError) {
                                siparsFrameworkClass.prototype.MessageSuccess();
                            }
                        });
                    }
...
//                        }
            ...
            DataTableEventXhr: function(){
                $('#' + $('.dataTable').attr('id')).on( 'xhr.dt', function(e, settings, json, xhr){
                    siparsFramework.CheckStatusSession(json);
                });
            },
...
//                            callback();
//                        }
                            siparsFrameworkClass.prototype.MessageSuccess("Il record e' stato cancellato con successo", "Cancellazione effettuata");
                        },
                        error: function (xhr, ajaxOptions, thrownError) {
                            siparsFrameworkClass.prototype.MessageSuccess();
                        }
                    ...
                    $.ajax({
                        ...
                        success: function (result) {
                            ...
                            if (retid != null && retid > 0) {
                                ...
                                if (res[0].esito == 1) {
                                    siparsFrameworkClass.prototype.MessageSuccess("Operazione completata con succcesso", "Operazione effettuata");
                                    if (fnCallbackSuccess) {
                                        fnCallbackSuccess();
                                    }
                                } else {
                                    siparsFrameworkClass.prototype.MessageError();
                                }
                            }
                        },
                        error: function (xhr, ajaxOptions, thrownError) {
...
var siparsFramework = new siparsFrameworkClass();