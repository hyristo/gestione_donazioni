                ...
                if (isset($value['children']) && count($value['children']) > 0) {
                                ...
                                <div class="card text-white bg-primary mb-3" style="width: 18rem;">                                    
                                    <div class="card-body">
                                      ...
                                      <p class="card-text">'.$v['description'].'</p>';
                                        ...
                                        if ($v['handler'] != "") {
                                            $navbar .= '<a class="btn bg-card6" id="' . $v['id'] . '" onclick="' . $v['handler'] . '" href="#"><i class="' . $v['icon'] . '"></i></a>';
                                        } else {
                                            $navbar .= '<a class="btn bg-card6" id="' . $v['id'] . '" href="' . $v['url'] . '"><i class="' . $v['icon'] . '"></i></a>';
                                        }
                        $navbar .='</div>
                                </div>
                            </div>';
                    ...
                    $navbar .='<div class="col-sm-4 p-2">
                                <div class="card text-white bg-primary mb-3" style="width: 18rem;">                                    
                                    ...
                                    if ($value['handler'] != "") {
                                        $navbar .= '<a class="btn bg-card6" id="' . $value['id'] . '" onclick="' . $value['handler'] . '" href="#"><i class="' . $value['icon'] . '"></i></a>';
                                    } else {
                                        $navbar .= '<a class="btn bg-card6" id="' . $value['id'] . '" href="' . $value['url'] . '"><i class="' . $value['icon'] . '"></i></a>';
                                    }
                        $navbar .='</div>
                                </div>
                            </div>';
