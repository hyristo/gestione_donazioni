...
function listCodiciVari(){
    ...
    foreach($res['empRecords'] as $row){
        ...
        $onclick = 'onclick="siparsFramework.takeChargeCodiciVari(\''.$row['ID_CODICE'].'\',\''.$row['GRUPPO'].'\',\'codici_vari\', \'load\' )"';
        ...
        if($row['CANCELLATO']==0){
            $onclickDisable = 'onclick="siparsFramework.takeChargeCodiciVari(\''.$row['ID_CODICE'].'\',\''.$row['GRUPPO'].'\',\'codici_vari\', \'delete\', \'#ListCodiciVari\' )"';
